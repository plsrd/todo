...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _eventsBus__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./eventsBus */ \"./src/eventsBus.js\");\n/* harmony import */ var _projectFormController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./projectFormController */ \"./src/projectFormController.js\");\n\n\n\nfunction initTaskController() {\n  _eventsBus__WEBPACK_IMPORTED_MODULE_0__.default.on('createTaskContainer', createTaskContainer);\n  _eventsBus__WEBPACK_IMPORTED_MODULE_0__.default.on('createTaskForm', createTaskForm);\n  _eventsBus__WEBPACK_IMPORTED_MODULE_0__.default.on('createTask', createTask);\n}\n\nfunction createTaskContainer(target) {\n  (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.createElement)('div', target, 'tasks-container', {'class': 'tasks-container', 'type': 'text', 'placeholder': 'task'});\n  (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.cacheElements)(['tasks-container']);\n  const container = _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.tasksContainer;\n  (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.createElement)('p', container, 'task-header', {}, 'Tasks')\n  ;(0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.createElement)('button', _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.tasksContainer, 'add-task', {'type': 'button', 'class': 'task-btn'}, '+');\n  (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.cacheElements)(['add-task']);\n  _eventsBus__WEBPACK_IMPORTED_MODULE_0__.default.emit('addTaskBtnCreated', _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.addTask);\n}\n\nfunction createTaskForm() {\n  if (!_projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.task) {\n    _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.addTask.classList.add('disabled');\n    const container = _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.tasksContainer;\n    (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.createInputFields)(['task'], container);\n    (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.createElement)('button', container, 'task-btn', {'type': 'button', 'class': 'task-btn'}, '+');\n    (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.cacheElements)(['task', 'task-btn']);\n    _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.tasks = [];\n    _eventsBus__WEBPACK_IMPORTED_MODULE_0__.default.emit('taskInputCreated', _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.task);\n    _eventsBus__WEBPACK_IMPORTED_MODULE_0__.default.emit('taskBtnCreated', _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.taskBtn);\n  }\n}\n\n\n\nclass Task {\n  constructor(task, status) {\n    this.task = task;\n    this.status = status;\n  }\n\n  set parent(id) {\n    this.project = id;\n  }\n\n  set identifier(id) {\n    this.id = id;\n  }\n}\n\nfunction createTask() {\n  const value = _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.task.value;\n  if (value) {\n    if (_projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.task.classList.contains('empty')) { _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.task.classList.remove('empty') }\n    _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.tasks.push(new Task(value, 'incomplete'));\n    drawTask(value);\n    _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.task.value = '';\n    _eventsBus__WEBPACK_IMPORTED_MODULE_0__.default.emit('updateTasks', _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.tasks);\n  } else {\n    _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.task.classList.add('empty');\n  }\n}\n\nfunction drawTask(value) {\n  (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.createElement)('div', _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.tasksContainer, 'created-tasks', {'class': 'created-task-container'});\n  (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.cacheElements)(['created-tasks']);\n  const container = _projectFormController__WEBPACK_IMPORTED_MODULE_1__.domCache.createdTasks;\n  (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.createElement)('input', container, 'none', {'type': 'checkbox', 'class': 'task', 'name': value});\n  (0,_projectFormController__WEBPACK_IMPORTED_MODULE_1__.createElement)('label', container, 'none', {'for': value}, value);\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initTaskController);\n\n//# sourceURL=webpack://todo/./src/taskController.js?");
